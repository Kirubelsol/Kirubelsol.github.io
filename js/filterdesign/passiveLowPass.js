    ...
    if(invalid.length === 0){
      ...
      <div class = "container-lg mt-5">
        ...
        <div class="text-center d-none d-xl-block mb-3 georgia-font">
          ...
          <img src="../img/filterdesign/RClowpass.PNG" class = "rounded" width = "40%" height = "40%" alt="RC Low Pass Filter">
          </span>
      ...
      <div class = "container-lg mt-5">
        ...
        <div class="text-center d-none d-xl-block mb-3">
          <span class="tt" data-bs-placement="bottom" title="RL Low Pass Filter Schematic">
            <img src="../img/filterdesign/RLlowpass.PNG" class = "rounded" width = "55%" height = "55%" alt="RL Low Pass Filter">
          </span>
