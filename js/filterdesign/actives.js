        ...
        <div class = "container-lg mt-5">
          ...
          <div class="text-center d-none d-xl-block mb-3">
            <span data-bs-placement="bottom" title="Active RC Low Pass Filter Schematic">
              <img src="../img/filterdesign/ActiveRLCLowPass.PNG" class = "rounded" width = "55%" height = "55%" alt="Active Low Pass Filter">
            </span>
        ...
        <div class = "container-lg mt-5">
          ...
          <div class="text-center d-none d-xl-block mb-3">
            <span data-bs-placement="bottom" title="Active RC high Pass Filter Schematic">
              <img src="../img/filterdesign/ActiveRLCHighPass.PNG" class = "rounded" width = "55%" height = "55%" alt="Active High Pass Filter">
            </span>
