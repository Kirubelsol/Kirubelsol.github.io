...
<div class = "container-lg mt-5">
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="RC Low Pass Filter Schematic">
            <img src="../img/filterdesign/RCLPF100.PNG" class = "rounded" alt="RC Low Pass Filter">
        </span>
...
<div class = "container-lg mt-5">
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="RL Low Pass Filter ">
            <img src="../img/filterdesign/RLLPF100.PNG" class = "rounded"  alt="RL Low Pass Filter">
        </span>
...
<div class = "container-lg mt-5">
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="RC high pass filter">
            <img src="../img/filterdesign/RCHPF100.PNG" class = "rounded"  alt="RC high Pass Filter">
        </span>
...
<div class = "container-lg mt-5">
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="RL high pass filter">
            <img src="../img/filterdesign/RLHPF100.PNG" class = "rounded"  alt="RL high Pass Filter">
        </span>
...
<div class = "container-lg mt-5">
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="Active RC low pass filter">
            <img src="../img/filterdesign/ActiveRRCLPF.PNG" class = "rounded"  alt="Active RC low Pass Filter">
        </span>
...
<div class = "container-lg mt-5">
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="Active RC high pass filter">
            <img src="../img/filterdesign/ActiveRCCHPF.PNG" class = "rounded"  alt="Active RC high Pass Filter">
        </span>
...
<div class = "container-lg mt-5">
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="Band-pass filter">
            <img src="../img/filterdesign/BandPass.PNG" class = "rounded"  alt="Band-pass Filter">
        </span>
...
<ul style="list-style-type:none; line-height: 2.5;" class = "mb-4 georgia-font ">  
    ...
    <div class="text-center d-none d-xl-block mb-3">
        <span class="tt" data-bs-placement="bottom" title="Band-stop filter">
            <img src="../img/filterdesign/Bandstop.PNG" class = "rounded"  alt="Band-stop Filter">
        </span>
